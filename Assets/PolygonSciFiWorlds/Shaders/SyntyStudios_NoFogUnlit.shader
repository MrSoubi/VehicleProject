...
Shader "SyntyStudios/NoFogUnlit"
{
	Properties
	{
		...
		[ASEBegin]_Planet_Texture("Planet_Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Rim_Texture = IN.ase_texcoord7.xy * _Rim_Texture_ST.xy + _Rim_Texture_ST.zw;
				...
				float2 uv_Planet_Texture = IN.ase_texcoord7.xy * _Planet_Texture_ST.xy + _Planet_Texture_ST.zw;
				float4 tex2DNode2 = tex2D( _Planet_Texture, uv_Planet_Texture );
				float2 uv_Glow_Texture = IN.ase_texcoord7.xy * _Glow_Texture_ST.xy + _Glow_Texture_ST.zw;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Planet_Texture = IN.ase_texcoord2.xy * _Planet_Texture_ST.xy + _Planet_Texture_ST.zw;
				float4 tex2DNode2 = tex2D( _Planet_Texture, uv_Planet_Texture );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Rim_Texture = IN.ase_texcoord2.xy * _Rim_Texture_ST.xy + _Rim_Texture_ST.zw;
				float4 tex2DNode11 = tex2D( _Rim_Texture, uv_Rim_Texture );
				float4 lerpResult16 = lerp( float4( 0,0,0,0 ) , ( tex2DNode11 * _Rim_Intensity ) , tex2DNode11);
				float2 uv_Planet_Texture = IN.ase_texcoord2.xy * _Planet_Texture_ST.xy + _Planet_Texture_ST.zw;
				float4 tex2DNode2 = tex2D( _Planet_Texture, uv_Planet_Texture );
				float2 uv_Glow_Texture = IN.ase_texcoord2.xy * _Glow_Texture_ST.xy + _Glow_Texture_ST.zw;
				float4 lerpResult8 = lerp( ( tex2DNode2 * ( _Planet_Tint * _Planet_Light ) ) , ( _Glow_Tint * _Glow_Intensity ) , tex2D( _Glow_Texture, uv_Glow_Texture ));
...
/*ASEBEGIN
Version=18921
3403.8;70.4;2052;1358;-92.32971;934.7297;1;True;True
...
Node;AmplifyShaderEditor.StaticSwitch;37;857.9426,-105.0399;Inherit;False;Property;_Soft_Blend_Switch;Soft_Blend_Switch;8;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=33F8D98DF4E7F5420FDF88EF5D0EF6E94C5D592C